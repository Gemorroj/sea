...
6.Заходим в админку apanel/ и настраеваем
===
Made by Sea.
2007.
-------
...
Стили перемещены в папку style
Админка перемещена в папку apanel
Улучшен сканер файлов


--------
10.05.2012
Исправлен сканер файлов
Исправлена смена языка через передачу GET переменной (http://example.com/?langpack=russian)


-------
xx.xx.2012
Перевод на использование шаблонизатора Smarty
