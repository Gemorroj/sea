...
Если Вы добавляете файлы через FTP, то ставьте папкам права 777!
...
Текст должен быть в кодировке UTF-8, так же следите за разметкой, т.к. описание обрабатывается учетом ббкода
