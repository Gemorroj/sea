<?php
/**
 * This file contains the implementation for the TDLY frame
 *
 * PHP version 5
 *
 ...
 * @version   CVS: $Id: TDLY.php 248624 2007-12-20 19:07:33Z alexmerz $
...
/**
 * Data stucture for TDLY frames in a tag
 * (Playlist delay)
 *
 ...
 */
class MP3_IDv2_Frame_TDLY extends MP3_IDv2_Frame_CommonText
{
    ...
    {
        $this->setId("TDLY");
        $this->setPurpose("Playlist delay");
    }
}
?>