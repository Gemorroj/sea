...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{$smarty.const.SEA_PUBLIC_DIRECTORY}apanel/jquery/jquery.mobile-1.3.2.min.css"/>
    <script src="{$smarty.const.SEA_PUBLIC_DIRECTORY}apanel/jquery/jquery-1.10.2.min.js"></script>
    <script src="{$smarty.const.SEA_PUBLIC_DIRECTORY}apanel/jquery/jquery.mobile-1.3.2.min.js"></script>
