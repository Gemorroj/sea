...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{$smarty.const.DIRECTORY}apanel/jquery/jquery.mobile-1.3.0-rc.1.min.css"/>
    <script src="{$smarty.const.DIRECTORY}apanel/jquery/jquery-1.9.1.min.js"></script>
    <script src="{$smarty.const.DIRECTORY}apanel/jquery/jquery.mobile-1.3.0-rc.1.min.js"></script>
