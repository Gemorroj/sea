...
<form action="{$smarty.const.SEA_PUBLIC_DIRECTORY}service?act=registration" method="post">
    <div class="row">
        <table>
            <tr>
            ...
            <tr>
                <th><img onclick="this.src=this.src+'&amp;'" alt="" src="{$smarty.const.SEA_PUBLIC_DIRECTORY}kcaptcha?{session_name()}={session_id()}" /></th>
