...
{block content}
    ...
    <div data-role="controlgroup">
        ...
        <a href="apanel.php?action=cleanonline" data-role="button" data-icon="delete">Очистка онлайн</a>
        <a href="apanel.php?action=cleannews" data-role="button" data-icon="delete">Очистка новостей</a>
        <a href="apanel.php?action=cleanusers" data-role="button" data-icon="delete">Очистка пользователей</a>
